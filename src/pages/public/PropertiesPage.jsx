          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {properties.map((prop) => (
                <div 
                  key={prop.id}
                  className="bg-white border border-outline-variant/30 rounded-2xl overflow-hidden shadow-soft-coastal hover:shadow-xl transition-all group flex flex-col h-full"
                >
