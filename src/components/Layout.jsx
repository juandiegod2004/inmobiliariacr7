        ...
        <div className="flex justify-between items-center px-margin-mobile py-3 max-w-container-max mx-auto">
          ...
          <div className="hidden md:flex gap-6 items-center">
            <Link
              ...
              className={`${activeSection === 'inicio' && location.pathname === '/'
            ...
            <a
              ...
              className={`${activeSection === 'featured' && location.pathname === '/'
                  ? 'text-secondary font-semibold border-b-2 border-secondary'
                  : 'text-on-surface-variant hover:text-primary transition-colors'
                } font-label-md text-label-md py-1`}
            >
            ...
            <a
              ...
              className={`${activeSection === 'vender' && location.pathname === '/'
                  ? 'text-secondary font-semibold border-b-2 border-secondary'
                  : 'text-on-surface-variant hover:text-primary transition-colors'
                } font-label-md text-label-md py-1`}
            >
            ...
            <a
              ...
              className={`${activeSection === 'about' && location.pathname === '/'
                  ? 'text-secondary font-semibold border-b-2 border-secondary'
                  : 'text-on-surface-variant hover:text-primary transition-colors'
                } font-label-md text-label-md py-1`}
            >
            ...
            <a
              ...
              className={`${activeSection === 'contact' && location.pathname === '/'
                  ? 'text-secondary font-semibold border-b-2 border-secondary'
                  : 'text-on-surface-variant hover:text-primary transition-colors'
                } font-label-md text-label-md py-1`}
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-surface border-t border-outline-variant/30 px-margin-mobile py-4 flex flex-col gap-4 animate-fade-in shadow-lg">
            <Link
              ...
              className={`font-semibold text-sm ${activeSection === 'inicio' && location.pathname === '/'
                  ? 'text-secondary'
            ...
            <a
              href="#featured"
              onClick={(e) => handleScrollToSection(e, 'featured')}
              className={`font-semibold text-sm ${activeSection === 'featured' && location.pathname === '/'
                  ? 'text-secondary'
                  : 'text-on-surface-variant hover:text-primary'
                }`}
            >
            ...
            <a
              href="#vender"
              onClick={(e) => handleScrollToSection(e, 'vender')}
              className={`font-semibold text-sm ${activeSection === 'vender' && location.pathname === '/'
                  ? 'text-secondary'
                  : 'text-on-surface-variant hover:text-primary'
                }`}
            >
            ...
            <a
              href="#about"
              onClick={(e) => handleScrollToSection(e, 'about')}
              className={`font-semibold text-sm ${activeSection === 'about' && location.pathname === '/'
                  ? 'text-secondary'
                  : 'text-on-surface-variant hover:text-primary'
                }`}
            >
            ...
            <a
              href="#contact"
              onClick={(e) => handleScrollToSection(e, 'contact')}
              className={`font-semibold text-sm ${activeSection === 'contact' && location.pathname === '/'
                  ? 'text-secondary'
                  : 'text-on-surface-variant hover:text-primary'
                }`}
            >
